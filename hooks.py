...
app_include_js = [
	"hrms.bundle.js",
	"/assets/hrms/js/desk_integration.js",
]
...
website_route_rules = [
	...
	{"from_route": "/hrms", "to_route": "hrms"},
	{"from_route": "/admin", "to_route": "hrms"},
	{"from_route": "/admin/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/dashboard", "to_route": "hrms"},
	{"from_route": "/login", "to_route": "hrms"},
	{"from_route": "/recruitment", "to_route": "hrms"},
	{"from_route": "/recruitment/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/job-openings", "to_route": "hrms"},
	{"from_route": "/applicants", "to_route": "hrms"},
	{"from_route": "/screening", "to_route": "hrms"},
	{"from_route": "/interviews", "to_route": "hrms"},
	{"from_route": "/job-offers", "to_route": "hrms"},
	{"from_route": "/employees", "to_route": "hrms"},
	{"from_route": "/employees/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/onboarding", "to_route": "hrms"},
	{"from_route": "/leave", "to_route": "hrms"},
	{"from_route": "/leave/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/shifts", "to_route": "hrms"},
	{"from_route": "/shift-assignments", "to_route": "hrms"},
	{"from_route": "/attendance", "to_route": "hrms"},
	{"from_route": "/attendance/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/overtime", "to_route": "hrms"},
	{"from_route": "/salary-components", "to_route": "hrms"},
	{"from_route": "/salary-structures", "to_route": "hrms"},
	{"from_route": "/salary-assignments", "to_route": "hrms"},
	{"from_route": "/payroll", "to_route": "hrms"},
	{"from_route": "/salary-slips", "to_route": "hrms"},
	{"from_route": "/salary-slips/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/user", "to_route": "hrms"},
	{"from_route": "/user/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/signup", "to_route": "hrms"},
	{"from_route": "/signup/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/candidate", "to_route": "hrms"},
	{"from_route": "/candidate/<path:app_path>", "to_route": "hrms"},
	{"from_route": "/candidate-applications", "to_route": "hrms"},
...
doc_events = {
	"Job Applicant": {
		"on_update": "hrms.api.candidate_api.sync_job_applicant_to_candidate_app",
	},
	"Interview": {
		"on_update": "hrms.api.candidate_api.sync_interview_to_candidate_app",
	},
	"User": {
		"validate": [
	...
	"Employee Overtime Log": {"validate": "hrms.api.shift_checkout.validate_overtime_log"},
	"Salary Slip": {
		"validate": "hrms.api.shift_checkout.sync_overtime_to_salary_slip",
...
scheduler_events = {
	"all": [
		...
		"hrms.api.shift_checkout.process_auto_checkout_and_attendance",
	],
	"hourly": [
