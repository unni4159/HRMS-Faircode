(() => {
  ...
  // frappe-html:/home/user/unni/hrms2-bench/apps/hrms/hrms/public/js/templates/employees_with_unmarked_attendance.html
...
{% } %}`;
  ...
  // frappe-html:/home/user/unni/hrms2-bench/apps/hrms/hrms/public/js/templates/feedback_summary.html
...
`;
  ...
  // frappe-html:/home/user/unni/hrms2-bench/apps/hrms/hrms/public/js/templates/feedback_history.html
  ...
  // frappe-html:/home/user/unni/hrms2-bench/apps/hrms/hrms/public/js/templates/rating.html
...
`;
  ...
  // ../hrms/hrms/public/js/utils/telemetry.js
  frappe.provide("hrms.telemetry");
  var HR_WORKSPACES = /* @__PURE__ */ new Set([
    "HR",
    "HR Setup",
    "Leaves",
    "Shift & Attendance",
  ...
  var HR_DOCTYPES = /* @__PURE__ */ new Set([
    "Employee",
    "Employee Checkin",
    "Attendance",
    "Attendance Request",
  ...
  var HR_REPORTS = /* @__PURE__ */ new Set([
  ...
  function hr_capture(event, props) {
    var _a;
    if (!((_a = frappe.telemetry) == null ? void 0 : _a.enabled))
      return;
    try {
  ...
  function resolve_pending_draft(route) {
    ...
    if (route[0] === "Form" && route[1] === doctype && route[2] === name)
      return;
    const draft = (_a = locals == null ? void 0 : locals[doctype]) == null ? void 0 : _a[name];
    if (draft) {
  ...
  function remember_pending_draft(route) {
    const name = route[2];
    const is_new = route[0] === "Form" && HR_DOCTYPES.has(route[1]) && typeof name === "string" && name.startsWith("new-");
  ...
  function track_route() {
    ...
    if (hit)
      hr_capture(hit.event, hit.props);
    remember_pending_draft(route);
  }
  function track_landing() {
    try {
      if (sessionStorage.getItem("hrms_landing_tracked"))
        return;
    ...
    const route = frappe.get_route() || [];
    const hit = classify(route);
    hr_capture("landed_on_desk", __spreadValues({
      route_type: route[0] || "",
...
//# sourceMappingURL=hrms.bundle.JRK7226S.js.map
